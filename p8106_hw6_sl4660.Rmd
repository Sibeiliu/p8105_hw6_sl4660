...
So the 95% confidence interval of adjusted ${\widehat r}^{2}$ is (`r lower_limit`,`r higher_limit`)
...
The distributio of $\log_(\beta_0 \times \beta_1)$is almost normal
...
So the 95% confidence interval of adjusted $log(\widehat \beta_0\times\widehat \beta_1)$ is (`r lower_limit1`,`r higher_limit2`)
